...
if(isset($_SESSION["loggedin"]) && $_SESSION["loggedin"] === true){
    header("location: ../Members/FormValidate.php");
    exit;
}
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" style="margin-top: -160px;">
					...
					<div class="wrap-input100 rs1-wrap-input100 validate-input m-b-20 <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>" data-validate="Type user name" >
						<input id="first-name" class="input100" value="<?php echo $username; ?>"type="text" name="username" placeholder="User name">
...
-->
				...
				<div class="login100-more" style="background-image: url('images/pexels-leon-martinez-2468339.jpg');"></div>
			</div>
		</div>
	</div>
