...
$rowCount = $db->getRows('members', $con);

// Initialize pagination class
$pagConfig = array(
    'baseURL' => 'table.php'.$searchStr,
    'totalRows' => $rowCount,
...
$rows = $db->getRows('members', $con);

$join = "SELECT trainer.name  "
...
<body>
    ...
    <div class="container-fluid">
        <h2 class="text-left text-black">Detail Of Customer</h2>
        <div class="text-center align-md" style="
    float: right;
    margin-top: -50px;">
            <a href="FormValidate.php" class="btn btn-primary">Form</a>
            ...
            <tbody>
              ...
              ?>
                <tr>
                    ...
                    <td scope="col"><?php echo $row['trainer'];?> </td>
                    ...
                    <td scope="col"><?php echo $row['payment'] ;?> </td>
                    <td scope="col"><?php echo $row['created_date'] ;?></td>
                    <td><?php echo "<a class='btn btn-success btn-sm'  href='memberupdate.php?id=".$row['id']."'>Edit</a>"?></td>

                    <td><?php echo "<a class='btn btn-danger btn-sm' onClick=\"javascript: return confirm('Please confirm deletion');\" href='delete.php?id=".$row['id']."'>Delete</a>"?></td>
